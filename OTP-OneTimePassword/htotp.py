...
def args_init():
    ...
    analizador.add_argument(
        "-g",
        help="Stores an encrypted hexadecimal key of at least 64 characters in a file 'ft_otp.key'.",
        action='store_true')
    analizador.add_argument(
        "-k",
...
def decrypt_data(gen_token, gen_token2):
    try:
        ...
        exit()
def generator_qr(token_decrypt):
...
if __name__ == "__main__":
    ...
    if not args.g and not args.k:
        ...
        try:
            ...
            print("Generate a time-based One-time Password using a file 'ft_otp.key' as first argument and 'master_key.key' as second one.")